...
-----------------------------------
  This project is a rough simulation of how an 80/ principle often occurs.  It simulates a row of cells in a petri dish, each of which may pseudo-randomly be fed a sugar.  Upon being fed, the cell will grow. As each cell gets larger in diameter, it becomes more likely to receive the next sugar drop.
